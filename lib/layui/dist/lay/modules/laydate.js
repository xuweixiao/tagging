...
;!function () {
    ...
    C.prototype = [], C.prototype.constructor = C, w.extend = function () {
        ...
        if (t.zIndex && (i.style.zIndex = t.zIndex), w.each(new Array(2), function (e) {
                ...
                }), c.insertBefore(m, c.children[0]), d.appendChild(c), r[e] = w.elem("div", {"class": "layui-laydate-control laydate-control-list-" + e}), r[e].appendChild(a), r[e].appendChild(d), o.push(i), s.push(d), l.push(c)
            }), w(d).html(function () {
                var e = [], i = [];
